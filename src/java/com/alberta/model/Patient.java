...
public class Patient {
    ...
    private String attendClinic;
    private String medicineOpt;
    private String steroidOpt;
    ...
    public String getAttendClinic() {
        return attendClinic;
    }

    public void setAttendClinic(String attendClinic) {
        this.attendClinic = attendClinic;
    }

    public String getMedicineOpt() {
        return medicineOpt;
    }

    public void setMedicineOpt(String medicineOpt) {
        this.medicineOpt = medicineOpt;
    }

    public String getSteroidOpt() {
        return steroidOpt;
    }

    public void setSteroidOpt(String steroidOpt) {
        this.steroidOpt = steroidOpt;
    }
